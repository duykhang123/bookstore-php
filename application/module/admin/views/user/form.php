...
$inputName        = Helper::cmsInput('text', 'form[username]', 'username', $dataForm['username'] ?? '', 'inputbox required', 40);
...
$selectGroup    = Helper::cmsSelecbox('form[group_id]', null, $this->slbGroup, $dataForm['group_id'] ?? '', 'width: 150px');
...
// Row
$rowName        = Helper::cmsRowForm('User Name', $inputName, true);
$rowEmail        = Helper::cmsRowForm('Email', $inputEmail, true);
$rowFullName        = Helper::cmsRowForm('FullName', $inputFullName, true);
...
$rowGroup    = Helper::cmsRowForm('Group Id', $selectGroup);
            ...
            <div class="width-100 fltlft">
                <fieldset class="adminform">
                    ...
                    <ul class="adminformlist">
                        <?php echo $rowName . $rowFullName . $rowEmail . $rowStatus . $rowGroup . $rowPassword . $rowOrdering . $rowID; ?>
                    </ul>
                    <div class="clr"></div>
                    <div>
                        <?php echo $inputToken; ?>
